...
//	void drawTexture( int x, int y, int w, int h, ProgGLSL& _prog);
    ...
    //
    void renderShadowVolumePolygonsWithGeometryShader( float _f_coef_extrusion );
    ...
    void renderShadowVolume( float f_coef_extrusion, bool b_use_zfail = false );
    //
    void renderSmoothiesPolygons(VertexDataBufferGL* _vbo, IndexBufferUI* _indexBuffer, ProgGLSL _prog_vbo, float _f_coef_extrusion);
    //void renderSmoothiesPolygons( float _f_coef_extrusion ) {
    void renderSmoothiesPolygonsWithGeometryShader( float _f_coef_extrusion );
    void renderSmoothies( float f_coef_extrusion, bool b_use_zfail );
...
private :
    ...
    //
    ProgGLSL prog_vbo_sv_geom;
    ProgGLSL prog_vbo_smoothies_geom;
